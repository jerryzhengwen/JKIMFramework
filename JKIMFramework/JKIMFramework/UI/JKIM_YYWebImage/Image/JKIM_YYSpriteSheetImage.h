...
/**
 ...
 The animation can be played by JKIM_YYAnimatedImageView.
 ...
 Sample Code:
    ...
    JKIM_YYSpriteSheetImage *sprite;
    sprite = [[JKIM_YYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    JKIM_YYAnimatedImageView *imgView = [JKIM_YYAnimatedImageView new];
 ...
 Sample Code:
    ...
    JKIM_YYSpriteSheetImage *sheet = ...;
    UIImageView *imageView = ...;
    imageView.image = sheet;
    imageView.layer.contentsRect = [sheet contentsRectForCALayerAtIndex:6];
 
 */
@interface JKIM_YYSpriteSheetImage : UIImage <JKIM_YYAnimatedImage>
