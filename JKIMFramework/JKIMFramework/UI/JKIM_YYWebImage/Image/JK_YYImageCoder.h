...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, JK_YYImageType) {
    JK_YYImageTypeUnknown = 0, ///< unknown
    JK_YYImageTypeJPEG,        ///< jpeg, jpg
    JK_YYImageTypeJPEG2000,    ///< jp2
    JK_YYImageTypeTIFF,        ///< tiff, tif
    JK_YYImageTypeBMP,         ///< bmp
    JK_YYImageTypeICO,         ///< ico
    JK_YYImageTypeICNS,        ///< icns
    JK_YYImageTypeGIF,         ///< gif
    JK_YYImageTypePNG,         ///< png
    JK_YYImageTypeWebP,        ///< webp
    JK_YYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, JK_YYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    JK_YYImageBlendNone = 0,
 ...
 */
@interface JK_YYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) JK_YYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) JK_YYImageBlendOperation blend;      ///< Frame blend operation.
 ...
 */
@interface JK_YYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) JK_YYImageType type;          ///< Image data type.
 ...
 */
- (nullable JK_YYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
 ...
 */
@interface JK_YYImageEncoder : NSObject

@property (nonatomic, readonly) JK_YYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(JK_YYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(JK_YYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(JK_YYImageDecoder *)decoder type:(JK_YYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (JK_YYImageCoder)
...
CG_EXTERN JK_YYImageType JK_YYImageDetectType(CFDataRef data);

/// Convert YYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable JK_YYImageTypeToUTType(JK_YYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to YYImageType.
CG_EXTERN JK_YYImageType JK_YYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable JK_YYImageTypeGetExtension(JK_YYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef JK_YYCGColorSpaceGetDeviceRGB(void);

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef JK_YYCGColorSpaceGetDeviceGray(void);

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL JK_YYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL JK_YYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation JK_YYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger JK_YYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable JK_YYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable JK_YYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable JK_YYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable JK_YYCGImageCreateEncodedData(CGImageRef imageRef, JK_YYImageType type, CGFloat quality);


/**
 Whether WebP is available in YYImage.
 */
CG_EXTERN BOOL JK_YYImageWebPAvailable(void);
 ...
 */
CG_EXTERN NSUInteger JK_YYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable JK_YYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, JK_YYImagePreset) {
    JK_YYImagePresetDefault = 0,  ///< default preset.
    JK_YYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    JK_YYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    JK_YYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    JK_YYImagePresetIcon,         ///< small-sized colorful images
    JK_YYImagePresetText          ///< text-like
};
 ...
 */
CG_EXTERN CFDataRef _Nullable JK_YYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             JK_YYImagePreset preset);
