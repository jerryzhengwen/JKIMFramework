...
/**
 ...
 Sample Code:
     ...
     JKIM_YYFrameImage *image = [JKIM_YYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     JKIM_YYAnimatedImageView *imageView = [JKIM_YYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface JKIM_YYFrameImage : UIImage <JKIM_YYAnimatedImage>
...
/**
 ...
 @return An initialized JKIM_YYFrameImage object, or nil when an error occurs.
 */
