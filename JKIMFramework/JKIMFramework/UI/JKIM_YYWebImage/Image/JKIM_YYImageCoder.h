...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, JKIM_YYImageType) {
    JKIM_YYImageTypeUnknown = 0, ///< unknown
    JKIM_YYImageTypeJPEG,        ///< jpeg, jpg
    JKIM_YYImageTypeJPEG2000,    ///< jp2
    JKIM_YYImageTypeTIFF,        ///< tiff, tif
    JKIM_YYImageTypeBMP,         ///< bmp
    JKIM_YYImageTypeICO,         ///< ico
    JKIM_YYImageTypeICNS,        ///< icns
    JKIM_YYImageTypeGIF,         ///< gif
    JKIM_YYImageTypePNG,         ///< png
    JKIM_YYImageTypeWebP,        ///< webp
    JKIM_YYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, JKIM_YYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    JKIM_YYImageBlendNone = 0,
    
    /**
     The frame should be composited onto the output buffer based on its alpha.
     */
    JKIM_YYImageBlendOver,
};

/**
 An image frame object.
 */
@interface JKIM_YYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) JKIM_YYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) JKIM_YYImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    JKIM_YYImageDecoder *decoder = [JKIM_YYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    JKIM_YYImageDecoder *decoder = [[JKIM_YYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface JKIM_YYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) JKIM_YYImageType type;          ///< Image data type.
 ...
 */
- (nullable JKIM_YYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in JKIM_YYImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    JKIM_YYImageEncoder *jpegEncoder = [[JKIM_YYImageEncoder alloc] initWithType:JKIM_YYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    JKIM_YYImageEncoder *gifEncoder = [[JKIM_YYImageEncoder alloc] initWithType:JKIM_YYImageTypeGIF];
 ...
 */
@interface JKIM_YYImageEncoder : NSObject

@property (nonatomic, readonly) JKIM_YYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(JKIM_YYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(JKIM_YYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(JKIM_YYImageDecoder *)decoder type:(JKIM_YYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (JKIM_YYImageCoder)
...
CG_EXTERN JKIM_YYImageType JKIM_YYImageDetectType(CFDataRef data);

/// Convert JKIM_YYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable JKIM_YYImageTypeToUTType(JKIM_YYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to JKIM_YYImageType.
CG_EXTERN JKIM_YYImageType JKIM_YYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable JKIM_YYImageTypeGetExtension(JKIM_YYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef JKIM_YYCGColorSpaceGetDeviceRGB();

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef JKIM_YYCGColorSpaceGetDeviceGray();

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL JKIM_YYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL JKIM_YYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation JKIM_YYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger JKIM_YYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable JKIM_YYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable JKIM_YYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable JKIM_YYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable JKIM_YYCGImageCreateEncodedData(CGImageRef imageRef, JKIM_YYImageType type, CGFloat quality);


/**
 Whether WebP is available in JKIM_YYImage.
 */
CG_EXTERN BOOL JKIM_YYImageWebPAvailable();
 ...
 */
CG_EXTERN NSUInteger JKIM_YYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable JKIM_YYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, JKIM_YYImagePreset) {
    JKIM_YYImagePresetDefault = 0,  ///< default preset.
    JKIM_YYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    JKIM_YYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    JKIM_YYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    JKIM_YYImagePresetIcon,         ///< small-sized colorful images
    JKIM_YYImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is JKIM_YYImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable JKIM_YYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             JKIM_YYImagePreset preset);
