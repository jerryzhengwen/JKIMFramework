 ...
 */
@interface JK_YYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) JK_YYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   JK_YYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(JK_YYWebImageOptions)options
                          cache:(nullable JK_YYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable JK_YYWebImageProgressBlock)progress
                      transform:(nullable JK_YYWebImageTransformBlock)transform
                     completion:(nullable JK_YYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
