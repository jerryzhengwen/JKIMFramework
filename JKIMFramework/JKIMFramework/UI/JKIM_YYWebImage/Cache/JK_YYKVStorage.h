 ...
 */
@interface JK_YYKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, JK_YYKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    JK_YYKVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    JK_YYKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    JK_YYKVStorageTypeMixed = 2,
};
 ...
 */
@interface JK_YYKVStorage : NSObject
...
@property (nonatomic, readonly) JK_YYKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(JK_YYKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable JK_YYKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable JK_YYKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<JK_YYKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<JK_YYKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
