...
/**
 JKIM_YYDiskCache is a thread-safe cache that stores key-value pairs backed by SQLite
 and file system (similar to NSURLCache's disk cache).
 
 JKIM_YYDiskCache has these features:
 ...
 */
@interface JKIM_YYDiskCache : NSObject
