//
//  MKAnnotationView+JKIM_YYWebImage.m
...
@interface MKAnnotationView_JKIM_YYWebImage : NSObject @end
@implementation MKAnnotationView_JKIM_YYWebImage @end


static int _JKIM_YYWebImageSetterKey;

@implementation MKAnnotationView (JKIM_YYWebImage)
