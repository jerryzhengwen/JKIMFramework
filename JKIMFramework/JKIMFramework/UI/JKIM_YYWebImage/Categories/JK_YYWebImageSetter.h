 ...
 */
static inline void _JK_yy_dispatch_sync_on_main_queue(void (^block)(void)) {
    if (pthread_main_np()) {
        block();
    } else {
...
extern NSString *const JK_YYWebImageFadeAnimationKey;
extern const NSTimeInterval JK_YYWebImageFadeTime;
extern const NSTimeInterval JK_YYWebImageProgressiveFadeTime;

/**
 Private class used by web image categories.
 Typically, you should not use this class directly.
 */
@interface JK_YYWebImageSetter : NSObject
/// Current image url.
