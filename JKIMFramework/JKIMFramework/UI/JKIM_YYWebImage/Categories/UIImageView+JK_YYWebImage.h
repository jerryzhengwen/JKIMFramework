 ...
 */
@interface UIImageView (JK_YYWebImage)
 ...
 */
- (void)yy_setImageWithURL:(nullable NSURL *)imageURL options:(JK_YYWebImageOptions)options;
...
/**
 ...
 @param options  The options to use when request the image.
 */
- (void)yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL options:(JK_YYWebImageOptions)options;
