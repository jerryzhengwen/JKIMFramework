...
/**
 The JKIM_YYWebImageOperation class is an NSOperation subclass used to fetch image
 from URL request.
 ...
 */
@interface JKIM_YYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) JKIM_YYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   JKIM_YYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(JKIM_YYWebImageOptions)options
                          cache:(nullable JKIM_YYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable JKIM_YYWebImageProgressBlock)progress
                      transform:(nullable JKIM_YYWebImageTransformBlock)transform
                     completion:(nullable JKIM_YYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
